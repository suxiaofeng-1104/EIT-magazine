...
%% leading paragraph. 
\blue{First para. by zja} Ultra-high-speed wireless communication are expected to play a cornerstone role in future applications including immersive virtual reality, digital twins, and holographic videos. 
...
\blue{Alternative first para.} Existing wireless systems use spatially discrete transceivers for communication. 
For example, single-input single-output (SISO) systems consider a pair of points as the transceivers, and MIMO systems regard discrete point sets in certain spatial region as the transceivers. 
...
%% Overview of recent progress in EIT. 
